            ...
            switch (keyInfo.Key)
            {
                ...
                case ConsoleKey.RightArrow:
                    ...
                    else
                    {
                        ...
                        {
                            if (LondonUnderground.Connections.ContainsKey(menuItems[selectedItemIndex].Parent.Parent.Label))
                            {
                                temp.Clear();
                                ...
                                if (menuItems[selectedItemIndex].Parent.Parent.Parent.Label == "Add Track Section Delay")
                                {
                                ...
                                LondonUnderground.HandleUserInput(menuItems[selectedItemIndex].Parent.Parent.Parent.Label, temp);
                            }
                        }
                        else
                        {
